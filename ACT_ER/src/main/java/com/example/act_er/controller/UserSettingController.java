...
//	}
	...
	public class UserSettingController {
		...
		//初期表示
	    @GetMapping("/view")
	    public String userSettingView(Model model){
	    	
	    	//初期表示かリダイレクトか判定する必要がある
...
//	  mav.addObject("employeeList", userSettingRepository.selectAll());
//
//	  System.out.println(userSettingRepository.selectAll());
//
//	  return mav;
//  }
